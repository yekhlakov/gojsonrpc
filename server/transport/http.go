...
func NewHttpTransport(hostName string) HttpTransport {
    ...
    go func() { _ = http.ListenAndServe(hostName, nil) }()
...
func (t *HttpTransport) AddServer(url string, s *server.JsonRpcServer) (*server.JsonRpcServer, error) {
...
func (t *HttpTransport) Process(s *server.JsonRpcServer, hrc * HttpRequestContext) (ok bool) {
